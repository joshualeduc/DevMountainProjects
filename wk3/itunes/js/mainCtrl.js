...
app.controller('mainCtrl', function($scope, itunesService){
  ...
  //Also note that that method should be retuning a promise, so you could use .then in this function.
    ...
    $scope.getSongData = function(){
      itunesService.getArtist($scope.artist).then(function(apiData){
        $scope.songData = apiData;
      });
    };
  ...
  //is sort the data you got back to be an object in the following format.
    /*
      AlbumArt: "http://a3.mzstatic.com/us/r30/Features4/v4/22/be/30/22be305b-d988-4525-453c-7203af1dc5a3/dj.srlprmuo.100x100-75.jpg" .artworkUrl130
      Artist: "Nelly" .artistName
      Collection: "Nellyville" .collectionName
      CollectionPrice: 11.99 .collectionPrice
      Play: "http://a423.phobos.apple.com/us/r1000/013/Music4/v4/4a/ab/7c/4aab7ce2-9a72-aa07-ac6b-2011b86b0042/mzaf_6553745548541009508.plus.aac.p.m4a" .previewUrl
      Type: "song" .kind
  */
